...
- [ ] Forms use **FormSubmit** → `career@thesquadinstitute.com` (activate via the first email FormSubmit sends)
...
- [ ] Confirm `career@thesquadinstitute.com` receives FormSubmit notifications
